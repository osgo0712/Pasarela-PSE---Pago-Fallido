...
import Steps.PagoFallidoStep;
import cucumber.api.java.en.Given;
import cucumber.api.java.en.Then;
import cucumber.api.java.en.When;
import net.thucydides.core.annotations.Steps;

public class PagoFallidoDefinition {
	
	@Steps
	PagoFallidoStep AgendamientoStep;
	...
	@When("^Ingresa fecha, seleccion estado fallida e ingresa codigo de authorizationID$")
	...
	public void transaccion_en_estado_rechazado() throws Throwable {
		AgendamientoStep.MensajeFallida();
	}
}
