...
Feature: Pagina de portal salud
  Como usuario deseo realizar pago de una de cita medica presencial en estado fallida
  	
		
  Scenario: Ingresar al modulo de salud y realizar transaccion de pago fallida de cita medica
    ...
    And Ingresa fecha, seleccion estado fallida e ingresa codigo de authorizationID
    And Hace click en boton call y Return to PPE
    Then Transaccion en estado fallida